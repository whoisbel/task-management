...
import { add_collaborator, add_project, view_project } from '../controllers/project.controller';
...
router.post('/project/:projectId/collaborator/:collaboratorId', validateJWT, add_collaborator);
